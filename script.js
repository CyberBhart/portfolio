...
<span class="output-line">Experience: 15+ years</span>
    ...
    const kaliResourcesDropdown = document.querySelector('.kali-resources-dropdown');
    const kaliResourcesBtn = document.querySelector('.kali-resources-btn');
    const kaliResourcesMenu = document.querySelector('.kali-resources-menu');
    ...
    if (kaliAppsBtn && kaliAppsMenu) {
        kaliAppsBtn.addEventListener('click', (e) => {
            ...
            // Close other menus
            if (kaliResourcesMenu) kaliResourcesMenu.style.display = 'none';
            if (kaliSwitchMenu) kaliSwitchMenu.style.display = 'none';
            kaliAppsMenu.style.display = isVisible ? 'none' : 'block';
        });
    }
    
    if (kaliResourcesBtn && kaliResourcesMenu) {
        kaliResourcesBtn.addEventListener('click', (e) => {
            e.stopPropagation();
            const isVisible = kaliResourcesMenu.style.display === 'block';
            // Close other menus
            if (kaliAppsMenu) kaliAppsMenu.style.display = 'none';
            if (kaliSwitchMenu) kaliSwitchMenu.style.display = 'none';
            kaliResourcesMenu.style.display = isVisible ? 'none' : 'block';
        });
    }
    ...
    document.addEventListener('click', (e) => {
        ...
        if (kaliResourcesMenu && !kaliResourcesDropdown?.contains(e.target)) {
            kaliResourcesMenu.style.display = 'none';
        }
